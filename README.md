...
**Estado actual: v0.2.9 — catálogo extendido de lenguajes (8 con AST chunking).**
...
**v0.2.9 — implementado y testeado:**
...
- `docs/LANGUAGES_ROADMAP.md` — Plan v0.2.9: registry `LangSpec` +
